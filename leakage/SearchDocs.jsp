...
<head>
<title>Searching Documents by Content..</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style27">Search Documents By Contents..</span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div>
            <p>&nbsp;</p>
            <form action="SearchFound.jsp" method="post" name="form1" id="form1">
              <p>&nbsp;</p>
              <table width="399" border="0" align="center">
                <tr>
                  <td width="183"><span class="style5 style26">Enter The Content Keyword </span></td>
                  <td width="206"><input type="text" name="t3" /></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li>
              <p><a href="SearchDocs.jsp">Home</a></p>
