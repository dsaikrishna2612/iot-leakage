...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style31 style46">Authorize Users..</span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          ...
          <div>
                ...
                <table width="630" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                  <tr>
                    ...
                    <td  width="113" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Email</div></td>
                    <td  width="105" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Address</div></td>
                    <td  width="75"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Status</div></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <%
						...
						{
						%>
                    <td width="70" height="0" align="center"  valign="middle"><div align="center" class="style22 style5 style20 style37 style55 style58 style46">
                        <%out.println(s4);%>
                    </div></td>
                    <%
						}
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li>
              <p><a href="S_AllUsersandAuthorize.jsp">Home</a></p>
