...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style31 style46">Documents Results..</span></h2>
          <p class="infopost">&nbsp;</p><br/>
          <div class="clr"></div>
         
          <div>
             
               <iframe width="550" height="400" src="Results.jsp"></iframe>
                <p>&nbsp;</p>
                <p align="right"><a href="ServerMain.jsp" class="style39">Back</a></p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li>
              <p><a href="S_DocsChart.jsp">Home</a></p>
