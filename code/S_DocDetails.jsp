...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style12"><span class="style40">Document <span class="style36"><strong><%=request.getParameter("title")%></strong></span> Details</span>..</span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
...
%>
                <table width="742" border="2" cellspacing="2" cellpadding="2">
                  <tr>
                    <td width="181" height="37" valign="middle"><span class="style2 style41  style47"><span class="style47 style2 style64"><span class="style68">Doc Image </span></span></span></td>
                  ...
                  <tr>
                    <td width="181" height="37"><span class="style63">Category</span></td>
                    <td width="539"><span class="style70 style55"><strong>
                      <%out.println(s2);%>
                    </strong></span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="37"><span class="style67"><span class="style63">Digital Sign</span></span></td>
                    <td><span class="style70 style55"><strong>
                      <%out.println(s8);%>
                    </strong></span></td>
                  </tr>
...
%>
                <p align="right"><a href="index.html" class="style10"></a><a href="S_DocDetails.jsp" class="style39"></a><a href="S_AllDocsWithImages.jsp" class="style39">Back</a></p>
