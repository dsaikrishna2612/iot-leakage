...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style31 style46">All Documents with Images..</span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          ...
          <div>
                ...
                <table width="604" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                  <tr>
                    ...
                    <td  width="206" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Document Image</div></td>
                    <td  width="198" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Document Title </div></td>
                    <td  width="144" valign="middle" height="34" style="color: #2c83b0;">&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td width="206" rowspan="1" align="center" valign="middle" ><div class="style22 style5 style37 style54 style55" style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
                        <input  name="image" type="image" src="images.jsp?id=<%=j%>" style="width:150px; height:150px;" />
                    </a> </div></td>
					...
					<form method="post" action="S_DocDetails.jsp">
                      <label>
                      <div align="center">
                        <p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li>
              <p><a href="S_AllDocsWithImages.jsp">Home</a></p>
