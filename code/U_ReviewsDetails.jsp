...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style12"><span class="style40"><span class="style46"><span class="style35"><span class="style40">User</span> <span class="style54"><%=(String)application.getAttribute("uname")%></span><span class="style36"><span class="style40">'s</span></span></span></span> Review Details</span>..</span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          ...
          <div>
                ...
                <table width="638" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                  <tr>
                    ...
                    <td  width="123" valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Title</div></td>
                    <td  width="120" valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Category</div></td>
                    <td  width="93" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Date</div></td>
                    <td  width="237" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Reviews</div></td>
                  </tr>         
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li>
              <p><a href="U_ReviewsDetails.jsp">Home</a></p>
